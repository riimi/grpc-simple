...
var (
	filter_CountService_Incr_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_CountService_Incr_0(ctx context.Context, marshaler runtime.Marshaler, client CountServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IncrRequest
	var metadata runtime.ServerMetadata

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_CountService_Incr_0); err != nil {
...
func RegisterCountServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CountServiceClient) error {
	...
	mux.Handle("POST", pattern_CountService_Incr_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CountService_Incr_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_CountService_Incr_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_CountService_Incr_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "count", "incr"}, ""))
)

var (
	forward_CountService_Incr_0 = runtime.ForwardResponseMessage
)
